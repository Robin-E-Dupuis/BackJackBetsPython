    ...
    if Bet > Balance:
        ...
        while True:
            ...
            if choice == "hit" or choice == "h":
                ...
                print("You leave this game of blackjack with ",Balance)
                break
            else:
